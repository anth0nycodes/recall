  ...
  return (
    <Dialog {...props}>
      ...
      <DialogContent
        ...
        className={cn(
          "data-open:zoom-in-0 data-closed:zoom-out-0 max-h-[calc(100dvh-4rem)] overflow-hidden rounded-xl! p-0 duration-0 data-closed:animate-none data-open:animate-none",
          className
        )}
...
function CommandInput({
  ...
  return (
    <div className="w-full" data-slot="command-input-wrapper">
      <InputGroup className="h-8! gap-2 rounded-lg! border-none p-0! shadow-none!">
        <CommandPrimitive.Input
          ...
          {...props}
        />
        <InputGroupAddon className="text-muted-foreground p-0!">
...
function CommandList({
  ...
  return (
    <CommandPrimitive.List
      ...
      className={cn(
        "no-scrollbar max-h-81.25 scroll-py-1 overflow-x-hidden overflow-y-auto outline-none",
        className
      )}
      {...props}
    />
